...
type IGoldGorillaServiceRepository interface {
	...
	SendAnswer(roomId string, peerId uint64, answer interface{}, connDirection ConnectionDirection) error
	SendOffer(roomId string, peerId uint64, offer interface{}, connDirection ConnectionDirection) error
