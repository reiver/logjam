...
export const raiseHandMaxLimitReached = computed(() => {
  return (
    sparkRTC.value && raisedHandsCount.value === sparkRTC.value.maxRaisedHands
  );
});
...
const displayStream = async (stream, toggleFull = false) => {
  console.log(`toggleFullScreen displayStream: ${toggleFull} stream: `, stream);
  let local = false;
      ...
      sparkRTC.value = createSparkRTC(role, {
        ...
        invitationToJoinStage: async (msg) => {
          ...
          previewDialogId = makePreviewDialog(
            ...
            {
              message:
                "The host has requested you to come on stage. Set the default state of your “Video” and “Audio” before joining please.",
              title: "Join The Stage",
