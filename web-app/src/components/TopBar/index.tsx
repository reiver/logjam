      ...
      <Container>
        <div class="grid grid-cols-12">
          ...
          <div class="col-span-6 flex items-center justify-center">
            {meetingStatus.value && <span class="text-black dark:text-white text-center text-bold-14 hidden sm:block">Is Your Future Distributed? Welcome to the Fediverse!</span>}
          </div>
